...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SRDynamicsControl Demo Installer\n"
      else:
        line="OutputBaseFilename=SRDynamicsControl Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SRDynamicsControl Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SRDynamicsControl installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SRDynamicsControl Demo installer\n"
     else:
       line="SetupWindowTitle=SRDynamicsControl installer\n"
