...
def main():
  ...
  plistpath = scriptpath + "/resources/SRDynamicsControl-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRDynamicsControl-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRDynamicsControl-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRDynamicsControl-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRDynamicsControl-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRDynamicsControl.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRDynamicsControl.iss",inplace=1):
