...
// !!! THESE ARE ALL ABANDONED, ONLY SAVED FOR POSSIBLE REUSE
...
//        {}
//
//        IText GetText(SR::Graphics::SRCustomTexts::ECustomTexts type = SR::Graphics::SRCustomTexts::ECustomTexts::kDefault) const { return mTexts[type]; }
//        void SetText(SR::Graphics::SRCustomTexts::ECustomTexts type, IText& text) { mTexts[type] = text; }
//
//      private:
//        float mSize;
